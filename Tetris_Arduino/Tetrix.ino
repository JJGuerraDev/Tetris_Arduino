...
ISR(TIMER1_OVF_vect)
{
    ...
    // Examinar_Alimentacion();
}

void Examinar_Alimentacion()
{

    // esaminar Alimentacion
    ...
    Voltaje_Bateria = busvoltage + (shuntvoltage / 1000);
